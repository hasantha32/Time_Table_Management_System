...
public class Manage_Session_Rooms {
	...
	private JTextField txtManageSessionRooms;
	...
	JMenuItem mntmNewMenuItem_34 = new JMenuItem("Visualizing Static");
		...
		lblNewLabel.setBounds(526, 156, 216, 22);
		frame.getContentPane().add(lblNewLabel);JLabel lblNewLabel_1 = new JLabel("Selection Session");
lblNewLabel_1.setForeground(Color.WHITE);
		lblNewLabel_1.setFont(new Font("Times New Roman", Font.BOLD, 14));
		lblNewLabel_1.setBounds(416, 199, 122, 20);
		frame.getContentPane().add(lblNewLabel_1);
		
		lblNewLabel_2 = new JLabel("Select Room");
		lblNewLabel_2.setForeground(Color.WHITE);
		lblNewLabel_2.setFont(new Font("Times New Roman", Font.BOLD, 14));
		lblNewLabel_2.setBounds(416, 253, 122, 20);
		frame.getContentPane().add(lblNewLabel_2);
		
		lblNewLabel_3 = new JLabel("Selected Session");
		lblNewLabel_3.setForeground(Color.WHITE);
		lblNewLabel_3.setFont(new Font("Times New Roman", Font.BOLD, 14));
		lblNewLabel_3.setBounds(420, 311, 122, 20);
		...
		comboBox.setBounds(552, 199, 241, 22);
		frame.getContentPane().add(comboBox);
		
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setBackground(Color.WHITE);
		comboBox_1.setBounds(552, 253, 241, 22);
		frame.getContentPane().add(comboBox_1);
		
		textField = new JTextField();
		textField.setBounds(556, 312, 241, 96);
		...
		btnManageSessionRooms.setForeground(new Color(255, 0, 0));
		...
		txtManageSessionRooms = new JTextField();
		txtManageSessionRooms.setEditable(false);
		txtManageSessionRooms.setText("                                                     MANAGE SESSION ROOMS");
		txtManageSessionRooms.setForeground(Color.RED);
		txtManageSessionRooms.setFont(new Font("Arial Black", Font.BOLD, 19));
		txtManageSessionRooms.setColumns(10);
		txtManageSessionRooms.setBackground(Color.BLACK);
		txtManageSessionRooms.setBounds(0, 84, 946, 29);
		frame.getContentPane().add(txtManageSessionRooms);
		...
		btnSubmit.setBounds(483, 502, 132, 35);
		...
		btnDelete_1.setBounds(687, 502, 132, 35);
		frame.getContentPane().add(btnDelete_1);
		
		JPanel panel_3 = new JPanel();
		panel_3.setBackground(Color.DARK_GRAY);
		panel_3.setBounds(308, 123, 588, 354);
