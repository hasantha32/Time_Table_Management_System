...
public class Genarate_Student_TimeTable {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Genarate_Student_TimeTable window = new Genarate_Student_TimeTable();
	 ...
	 */
	public Genarate_Student_TimeTable() {
		initialize();
	}
	...
	JMenuItem mntmNewMenuItem_34 = new JMenuItem("Visualizing Static");
		...
		panel_3.setBounds(198, 150, 738, 87);
