...
public class Genarate_Lecturer_Time_Table {
	...
	private JTextField txtGenerateTimeTables;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Genarate_Lecturer_Time_Table window = new Genarate_Lecturer_Time_Table();
	 ...
	 */
	public Genarate_Lecturer_Time_Table() {
		initialize();
	}
	...
	JMenuItem mntmNewMenuItem_34 = new JMenuItem("Visualizing Static");
		...
		btnManageNotAvailable.setForeground(new Color(255, 0, 0));
		...
		btnManageSessions.setForeground(new Color(255, 255, 255));
		...
		txtGenerateTimeTables = new JTextField();
		txtGenerateTimeTables.setEditable(false);
		txtGenerateTimeTables.setText("                                                       GENERATE TIME TABLES");
		txtGenerateTimeTables.setForeground(Color.RED);
		txtGenerateTimeTables.setFont(new Font("Arial Black", Font.BOLD, 19));
		txtGenerateTimeTables.setColumns(10);
		txtGenerateTimeTables.setBackground(Color.BLACK);
		txtGenerateTimeTables.setBounds(0, 84, 946, 29);
		frame.getContentPane().add(txtGenerateTimeTables);
		...
		textField_1.setBounds(0, 0, 946, 82);
		...
		panel_3.setBounds(194, 146, 742, 87);
