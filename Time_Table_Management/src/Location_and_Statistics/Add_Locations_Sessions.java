...
public class Add_Locations_Sessions {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Add_Locations_Sessions window = new Add_Locations_Sessions();
	...
	JMenuItem mntmNewMenuItem_34 = new JMenuItem("Visualizing Static");
		...
		scrollPane.setBounds(285, 155, 582, 240);
		...
		panel_1.setBounds(0, 393, 194, 128);
		frame.getContentPane().add(panel_1);
		
		JPanel panel = new JPanel();
		panel.setBackground(Color.GRAY);
		panel.setBounds(0, 519, 194, 53);
		...
		panel_1_1.setBounds(0, 113, 194, 186);
		frame.getContentPane().add(panel_1_1);
		
		textField = new JTextField();
		textField.setEditable(false);
		textField.setText("                                                            ADD LOCATIONS");
		textField.setForeground(Color.RED);
		textField.setFont(new Font("Arial Black", Font.BOLD, 19));
		textField.setColumns(10);
		textField.setBackground(Color.BLACK);
		textField.setBounds(0, 84, 946, 29);
		...
		btnAddRoom.setForeground(new Color(240, 248, 255));
		btnAddRoom.setFont(new Font("SansSerif", Font.BOLD, 13));
		btnAddRoom.setBackground(Color.BLACK);
		btnAddRoom.setBounds(392, 506, 132, 35);
		...
		btnClear_1.setBounds(617, 506, 132, 35);
		frame.getContentPane().add(btnClear_1);
		
		JButton btnSessions = new JButton("SESSIONS");
		btnSessions.setForeground(new Color(255, 0, 0));
		btnSessions.setFont(new Font("Arial Black", Font.BOLD, 11));
		btnSessions.setBackground(Color.BLACK);
		btnSessions.setBounds(0, 300, 194, 35);
		...
		btnConsecutive.setFont(new Font("Arial Black", Font.BOLD, 11));
		btnConsecutive.setBackground(Color.BLACK);
		btnConsecutive.setBounds(0, 334, 194, 29);
		frame.getContentPane().add(btnConsecutive);
		
		JButton btnNotAvailableTimes = new JButton("NOT AVAILABLE TIMES");
		btnNotAvailableTimes.setForeground(new Color(255, 255, 255));
		btnNotAvailableTimes.setFont(new Font("Arial Black", Font.BOLD, 11));
		btnNotAvailableTimes.setBackground(Color.BLACK);
		btnNotAvailableTimes.setBounds(0, 360, 194, 35);
		frame.getContentPane().add(btnNotAvailableTimes);
		
		JPanel panel_3 = new JPanel();
		panel_3.setBackground(Color.DARK_GRAY);
		panel_3.setBounds(240, 133, 665, 340);
