...
public class Add_Locations {
	...
	JMenuItem mntmNewMenuItem_34 = new JMenuItem("Visualizing Static");
		...
		chckbxLaboratary.setBounds(696, 347, 125, 26);
		frame.getContentPane().add(chckbxLaboratary);
		
		JCheckBox chckbxLecture = new JCheckBox("Lecture Hall");
		chckbxLecture.setSelected(true);
		chckbxLecture.setForeground(Color.WHITE);
		chckbxLecture.setFont(new Font("Trebuchet MS", Font.PLAIN, 20));
		chckbxLecture.setBackground(Color.GRAY);
		chckbxLecture.setBounds(529, 347, 141, 26);
		frame.getContentPane().add(chckbxLecture);
		...
		textField.setBounds(529, 246, 237, 20);
		frame.getContentPane().add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(529, 399, 241, 20);
		frame.getContentPane().add(textField_1);JLabel lblNewLabel_1 = new JLabel("Add Rooms Building wise:");
lblNewLabel_1.setForeground(Color.WHITE);
		lblNewLabel_1.setFont(new Font("Times New Roman", Font.BOLD, 14));
		lblNewLabel_1.setBounds(397, 191, 228, 20);
		frame.getContentPane().add(lblNewLabel_1);
		
		lblNewLabel_2 = new JLabel("Room Type");
		lblNewLabel_2.setForeground(Color.WHITE);
		lblNewLabel_2.setFont(new Font("Times New Roman", Font.BOLD, 14));
		lblNewLabel_2.setBounds(397, 347, 122, 20);
		frame.getContentPane().add(lblNewLabel_2);
		
		lblNewLabel_3 = new JLabel("Building Name");
		lblNewLabel_3.setForeground(Color.WHITE);
		lblNewLabel_3.setFont(new Font("Times New Roman", Font.BOLD, 14));
		lblNewLabel_3.setBounds(397, 245, 118, 20);
		frame.getContentPane().add(lblNewLabel_3);
		
		lblNewLabel_7 = new JLabel("Capacity");
		lblNewLabel_7.setForeground(Color.WHITE);
		lblNewLabel_7.setFont(new Font("Times New Roman", Font.BOLD, 14));
		lblNewLabel_7.setBounds(397, 397, 114, 20);
		...
		lblNewLabel_3_1.setBounds(397, 292, 114, 20);
		frame.getContentPane().add(lblNewLabel_3_1);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(529, 293, 237, 20);
		frame.getContentPane().add(textField_2);
		
		panel_1 = new JPanel();
		panel_1.setBackground(Color.GRAY);
		panel_1.setBounds(0, 113, 174, 186);
		frame.getContentPane().add(panel_1);
		
		btnAddLocations = new JButton("ADD LOCATIONS");
		btnAddLocations.setForeground(Color.RED);
		...
		btnManageLocations.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Manage_Locations addlecturer=new Manage_Locations();
				Manage_Locations.main(null);
				frame.setVisible(false);
		...
		btnManageLocations.setForeground(new Color(255, 255, 255));
		...
		txtAddLocations.setEditable(false);
		txtAddLocations.setText("                                                            ADD LOCATIONS");
		txtAddLocations.setForeground(Color.RED);
		txtAddLocations.setFont(new Font("Arial Black", Font.BOLD, 19));
		txtAddLocations.setColumns(10);
		txtAddLocations.setBackground(Color.BLACK);
		txtAddLocations.setBounds(0, 84, 946, 29);
		...
		btnClear_2.setBounds(423, 519, 132, 35);
		frame.getContentPane().add(btnClear_2);
		
	
		
		btnClear_1 = new JButton("Save");
		...
		btnClear_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String buildName=textField.getText().toString();
				String roomName=textField_2.getText().toString();
				String rcapacity=textField_1.getText().toString();
				
				
				
				String lecturer_hall="-";
				String lab="-";
				
				
				
				if(chckbxLecture.isSelected()) {
					lecturer_hall="LecturerHall";
				}
				if(chckbxLaboratary.isSelected()) {
					lab="Laboratary";
				}
		...
		try {
			...
			String query = "INSERT INTO location values (null,'"+buildName+"','"+roomName+"','"+rcapacity+"','"+lecturer_hall+"','"+lab+"')";
		...
		btnClear_1.setBounds(627, 519, 132, 35);
		frame.getContentPane().add(btnClear_1);
		
		
		JPanel panel_3 = new JPanel();
		panel_3.setBackground(Color.DARK_GRAY);
		panel_3.setBounds(237, 151, 657, 340);
